# LibMcuLL example program for LPC824 nuclone board
This project contains a example program for the LPC824 nuclone board and is intended as an example how to use LibMcuLL for the LPC824 microcontroller.
## Checking out
...
* LPC824 test board, see HSI for more information on connections
# TODO
The following tasks are still open:
* create a HSI (Hardware Software Interface) for the LPC824 test board
