...
#define SYSCFG ((SYSCFG_Type *)SYSINFO_BASE)
#define SYSCFG_XOR ((SYSCFG_Type *)SYSINFO_BASE + 0x1000)
#define SYSCFG_SET ((SYSCFG_Type *)SYSINFO_BASE + 0x2000)
#define SYSCFG_CLR ((SYSCFG_Type *)SYSINFO_BASE + 0x3000)
