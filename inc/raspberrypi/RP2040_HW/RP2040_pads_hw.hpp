...
constexpr inline std::uint32_t DRIVE_2MA{0x0u << 4};        /*!< 2 milliAmpere drive level */
constexpr inline std::uint32_t DRIVE_4MA{0x1u << 4};        /*!< 4 milliAmpere drive level */
constexpr inline std::uint32_t DRIVE_8MA{0x2u << 4};        /*!< 8 milliAmpere drive level */
constexpr inline std::uint32_t DRIVE_12MA{0x3u << 4};       /*!< 12 milliAmpere drive level */
