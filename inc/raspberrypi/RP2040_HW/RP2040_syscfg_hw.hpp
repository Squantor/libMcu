...
constexpr inline std::uint32_t kRESERVED_MASK{0xFF00'0003u}; /*!< Mask for allowed bits */
}  // namespace PROC_CONFIG
namespace PROC_IN_SYNC_BYPASS {
constexpr inline std::uint32_t kRESERVED_MASK{0x3FFF'FFFFu}; /*!< Mask for allowed bits */
}  // namespace PROC_IN_SYNC_BYPASS
namespace PROC_IN_SYNC_BYPASS_HI {
constexpr inline std::uint32_t kRESERVED_MASK{0x0000'003Fu}; /*!< Mask for allowed bits */
}  // namespace PROC_IN_SYNC_BYPASS_HI
namespace DBGFORCE {
