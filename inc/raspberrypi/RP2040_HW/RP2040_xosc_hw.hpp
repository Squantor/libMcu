...
namespace STATUS {
constexpr inline std::uint32_t kRESERVED_MASK{0x8100'1003u}; /*!< mask for allowed bits */
...
namespace STARTUP {
constexpr inline std::uint32_t kRESERVED_MASK{0x0010'3FFFu}; /*!< mask for allowed bits */
...
namespace COUNT {
constexpr inline std::uint32_t kRESERVED_MASK{0x0000'00FF}; /*!< mask for allowed bits */
}  // namespace COUNT
}  // namespace libmcuhw::xosc
#endif