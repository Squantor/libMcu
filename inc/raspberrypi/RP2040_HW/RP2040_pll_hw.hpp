...
namespace CS {
constexpr inline std::uint32_t kRESERVED_MASK{0x8000'013Fu}; /*!< Mask for allowed bits */
...
namespace PWR {
constexpr inline std::uint32_t kRESERVED_MASK{0x0000'002Du}; /*!< Mask for allowed bits */
...
namespace PRIM {
constexpr inline std::uint32_t kRESERVED_MASK{0x0007'7000u}; /*!< Mask for allowed bits */
/**
