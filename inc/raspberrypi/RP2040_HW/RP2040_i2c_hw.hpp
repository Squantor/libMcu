...
namespace IC_CON {
constexpr inline std::uint32_t kRESERVED_MASK{0x0000'07FFu};   /*!< Mask for allowed bits */
...
namespace IC_SAR {
constexpr inline std::uint32_t kRESERVED_MASK{0x0000'03FFu}; /*!< Mask for allowed bits */
}  // namespace IC_SAR
namespace IC_DATA_CMD {
constexpr inline std::uint32_t kRESERVED_MASK{0x0000'0FFFu};   /*!< Mask for allowed bits */
...
constexpr inline std::uint32_t kRESERVED_MASK{0x0000'1FFFu}; /*!< Mask for allowed bits */
...
constexpr inline std::uint32_t kRESERVED_MASK{0x00FF'FFFFu};     /*!< Mask for allowed bits */
...
constexpr inline std::uint32_t kRESERVED_MASK{0xFF81'FFFFu}; /*!< Mask for allowed bits */
/**
