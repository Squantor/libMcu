...
namespace FREQA {
constexpr inline std::uint32_t kRESERVED_MASK{0xFFFF'7777u}; /*!< mask for allowed bits */
...
namespace STATUS {
constexpr inline std::uint32_t kRESERVED_MASK{0x8101'1000u}; /*!< Mask for allowed bits */
