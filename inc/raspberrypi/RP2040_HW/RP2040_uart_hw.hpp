...
namespace UARTFR {
constexpr inline std::uint32_t kRESERVED_MASK{0x0000'01FFu}; /*!< Mask for allowed bits */
...
namespace UARTCR {
constexpr inline std::uint32_t kRESERVED_MASK{0x0000'FF87u}; /*!< Mask for allowed bits */
...
namespace UARTDMACR {
constexpr inline std::uint32_t kRESERVED_MASK{0x0000'0007u}; /*!< Mask for allowed bits */
