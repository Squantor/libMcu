...
constexpr inline std::uint32_t SPOL{1u << 8};         /*!< SSEL0 Polarity select */
}  // namespace CFG
namespace DLY {
...
constexpr inline std::uint32_t RXRDYEN{1u << 0};           /*!< enable received data available interrupt */
constexpr inline std::uint32_t TXRDYEN{1u << 1};           /*!< enable write to transmit register interrupt */
constexpr inline std::uint32_t RXOVEN{1u << 2};            /*!< enable receiver overrun interrupt */
constexpr inline std::uint32_t TXUREN{1u << 3};            /*!< enable transmitter underrun interrupt */
constexpr inline std::uint32_t SSAEN{1u << 4};             /*!< enable slave selected interrupt */
constexpr inline std::uint32_t SSDEN{1u << 5};             /*!< enable slave deselected interrupt */
}  // namespace INTENSET
namespace INTENCLR {
constexpr inline std::uint32_t RESERVED_MASK{0x0000003Fu}; /*!< register mask for allowed bits */
...
constexpr inline std::uint32_t RXSSEL_N{1u << 16}; /*!< Slave 0 selected for receive transaction, zero is active */
...
constexpr inline std::uint32_t TXSSEL_N{1u << 16}; /*!< This field asserts SSEL0 in master mode.*/
/**
