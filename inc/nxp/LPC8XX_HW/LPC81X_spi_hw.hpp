...
namespace CFG {
constexpr inline std::uint32_t kkRESERVED_MASK{0x1BDu}; /*!< register mask for allowed bits */
...
namespace STAT {
constexpr inline std::uint32_t kkRESERVED_MASK{0x000001FFu}; /*!< register mask for allowed bits */
...
namespace RXDAT {
constexpr inline std::uint32_t kkRESERVED_MASK{0x0011FFFFu}; /*!< register mask for allowed bits */
/**
...
namespace TXDATCTL {
constexpr inline std::uint32_t kkRESERVED_MASK{0x0F71FFFFu}; /*!< register mask for allowed bits */
/**
...
namespace TXCTL {
constexpr inline std::uint32_t kkRESERVED_MASK{0x0F710000u}; /*!< register mask for allowed bits */
/**
 * @brief Format data transmit length to TXDATCTL register field
 *
 * @param length amount of data to transmit
