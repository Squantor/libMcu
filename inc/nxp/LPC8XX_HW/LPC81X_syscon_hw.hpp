...
constexpr inline std::uint32_t SYS{1u << 0};              /*!< clock enable for AHB, APB bridge, SYSCON and core */
constexpr inline std::uint32_t ROM{1u << 1};              /*!< clock enable for ROM */
constexpr inline std::uint32_t RAM{1u << 2};              /*!< clock enable for RAM */
constexpr inline std::uint32_t FLASHREG{1u << 3};         /*!< clock enable for FLASHREG */
constexpr inline std::uint32_t FLASH{1u << 4};            /*!< clock enable for FLASH */
constexpr inline std::uint32_t I2C{1u << 5};              /*!< clock enable for I2C */
constexpr inline std::uint32_t GPIO{1u << 6};             /*!< clock enable for GPIO */
constexpr inline std::uint32_t SWM{1u << 7};              /*!< clock enable for SWM */
constexpr inline std::uint32_t SCT{1u << 8};              /*!< clock enable for SCT */
constexpr inline std::uint32_t WKT{1u << 9};              /*!< clock enable for WKT */
constexpr inline std::uint32_t MRT{1u << 10};             /*!< clock enable for BLA */
constexpr inline std::uint32_t SPI0{1u << 11};            /*!< clock enable for SPI0 */
constexpr inline std::uint32_t SPI1{1u << 12};            /*!< clock enable for SPI1 */
constexpr inline std::uint32_t CRC{1u << 13};             /*!< clock enable for CRC */
constexpr inline std::uint32_t UART0{1u << 14};           /*!< clock enable for UART0 */
constexpr inline std::uint32_t UART1{1u << 15};           /*!< clock enable for UART1 */
constexpr inline std::uint32_t UART2{1u << 16};           /*!< clock enable for UART2 */
constexpr inline std::uint32_t WWDT{1u << 17};            /*!< clock enable for WWDT */
constexpr inline std::uint32_t IOCON{1u << 18};           /*!< clock enable for IOCON */
constexpr inline std::uint32_t ACMP{1u << 19};            /*!< clock enable for BLA */
}  // namespace SYSAHBCLKCTRL
