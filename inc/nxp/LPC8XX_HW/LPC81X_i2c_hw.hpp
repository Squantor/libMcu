 ...
 * @brief Register structure and bit definitions for the LPC810 series I2C
 */
#ifndef LPC81X_I2C_HW_HPP
#define LPC81X_I2C_HW_HPP
...
namespace CFG {
constexpr inline std::uint32_t kkRESERVED_MASK{0x0000001Fu}; /*!< register mask for allowed bits */
...
namespace STAT {
constexpr inline std::uint32_t kkRESERVED_MASK{0x030FFF5Fu}; /*!< register mask for allowed bits */
...
namespace INTENSET {
constexpr inline std::uint32_t kkRESERVED_MASK{0x030B8951u}; /*!< register mask for allowed bits */
...
namespace TIMEOUT {
constexpr inline std::uint32_t kkRESERVED_MASK{0x0000FFFFu}; /*!< register mask for allowed bits */
/**
...
namespace MSTCTL {
constexpr inline std::uint32_t kkRESERVED_MASK{0x00000007u}; /*!< register mask for allowed bits */
...
namespace MSTTIME {
constexpr inline std::uint32_t kkRESERVED_MASK{0x00000077u}; /*!< register mask for allowed bits */
/**
...
namespace MONRXDAT {
constexpr inline std::uint32_t kkRESERVED_MASK{0x000007FFu}; /*!< register mask for allowed bits */
/**
