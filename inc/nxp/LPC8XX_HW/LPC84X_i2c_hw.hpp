 ...
 * @brief LPC840 I2C register interface
 */
...
constexpr inline std::uint32_t MSTDMA{1u << 3};            /*!< Master DMA control */
}  // namespace MSTCTL
namespace MSTTIME {
...
constexpr inline std::uint32_t SLVDMA{1u << 2};            /*!< Slave DMA enable */
}  // namespace SLVCTL
namespace SLVDAT {
constexpr inline std::uint32_t RESERVED_MASK{0x000000FFu}; /*!< register mask for allowed bits */
/**
