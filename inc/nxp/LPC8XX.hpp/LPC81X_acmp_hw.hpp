...
constexpr inline std::uint32_t COMPSA = (1 << 6);               /**< comparator output synchronized to bus clock */
...
constexpr inline std::uint32_t COMP_VP_SEL_ACMP_I2 = (6 << 8);  /**< comparator plus connected to internal reference */
...
constexpr inline std::uint32_t COMP_VM_SEL_ACMP_I2 = (6 << 11); /**< comparator minus connected to internal reference */
