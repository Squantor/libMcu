...
namespace CFG {
constexpr inline std::uint32_t MASK = 0x1BD;      /**< register mask for allowed bits */
...
namespace RXDAT {
constexpr inline std::uint32_t MASK = 0x0011FFFF; /**< register mask for allowed bits */
/**
...
namespace TXDATCTL {
constexpr inline std::uint32_t MASK = 0x0F71FFFF; /**< register mask for allowed bits */
/**
...
namespace TXCTL {
constexpr inline std::uint32_t MASK = 0x0F710000; /**< register mask for allowed bits */
/**
 * @brief Format data transmit length to TXDATCTL register field
 *
 * @param length amount of data to transmit
