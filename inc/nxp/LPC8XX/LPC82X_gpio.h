...
typedef struct {
    ...
    volatile uint32_t DIRSET[32];   /* Set Direction */
    volatile uint32_t DIRCLR[32];   /* Clear Direction */
    volatile uint32_t DIRNOT[32];   /* Toggle Direction */
} LPC_GPIO_T;
