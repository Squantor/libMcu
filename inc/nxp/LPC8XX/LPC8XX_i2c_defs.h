...
typedef volatile struct {      /*!< I2C0 Structure */
  uint32_t CFG;                /*!< I2C Configuration Register common for Master, Slave and Monitor */
  uint32_t STAT;               /*!< I2C Status Register common for Master, Slave and Monitor */
  uint32_t INTENSET;           /*!< I2C Interrupt Enable Set Register common for Master, Slave and Monitor */
  uint32_t INTENCLR;           /*!< I2C Interrupt Enable Clear Register common for Master, Slave and Monitor */
  uint32_t TIMEOUT;            /*!< I2C Timeout value Register */
  uint32_t CLKDIV;             /*!< I2C Clock Divider Register */
  const uint32_t INTSTAT;      /*!< I2C Interrupt Status Register */
  const uint32_t RESERVED0;    /*!< reserved */
  uint32_t MSTCTL;             /*!< I2C Master Control Register */
  uint32_t MSTTIME;            /*!< I2C Master Time Register for SCL */
  uint32_t MSTDAT;             /*!< I2C Master Data Register */
  const uint32_t RESERVED1[5]; /*!< reserved */
  uint32_t SLVCTL;             /*!< I2C Slave Control Register */
  uint32_t SLVDAT;             /*!< I2C Slave Data Register */
  uint32_t SLVADR[4];          /*!< I2C Slave Address Registers */
...
#define I2C_TIMEOUT_VAL(n)                                                    \
  (((uint32_t)((n)-1) & 0xFFF0) | 0x000F) /* Macro for Timeout value register \
                                           */
