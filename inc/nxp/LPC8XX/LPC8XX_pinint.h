...
typedef volatile struct {
  ...
  uint32_t SIENF;  /**< Set Pin Interrupt Enable Falling Edge / Active Level
                      register */
  uint32_t CIENF;  /**< Clear Pin Interrupt Enable Falling Edge / Active Level
                      address */
  ...
  uint32_t PMCFG; /**< GPIO pattern match interrupt bit slice configuration
                     register */
} PIN_INT_Type;
