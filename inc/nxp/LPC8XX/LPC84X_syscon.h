...
typedef volatile struct SYSCON_Struct {
  ...
  uint32_t FRODIRECTCLKUEN; /**< FRO direct clock source update enable register,
                               offset: 0x30 */
  ...
  uint32_t IOCONCLKDIV6; /**< Peripheral clock 6 to the IOCON block for
                            programmable glitch filter, offset: 0x134 */
  uint32_t IOCONCLKDIV5; /**< Peripheral clock 6 to the IOCON block for
                            programmable glitch filter, offset: 0x138 */
  uint32_t IOCONCLKDIV4; /**< Peripheral clock 4 to the IOCON block for
                            programmable glitch filter, offset: 0x13C */
  uint32_t IOCONCLKDIV3; /**< Peripheral clock 3 to the IOCON block for
                            programmable glitch filter, offset: 0x140 */
  uint32_t IOCONCLKDIV2; /**< Peripheral clock 2 to the IOCON block for
                            programmable glitch filter, offset: 0x144 */
  uint32_t IOCONCLKDIV1; /**< Peripheral clock 1 to the IOCON block for
                            programmable glitch filter, offset: 0x148 */
  ...
  uint32_t PINTSEL[8]; /**< Pin interrupt select registers N, array offset:
                          0x178, array step: 0x4 */
  uint8_t RESERVED_11[108];
  uint32_t STARTERP0; /**< Start logic 0 pin wake-up enable register 0, offset:
                         0x204 */
  uint8_t RESERVED_12[12];
  uint32_t STARTERP1; /**< Start logic 0 pin wake-up enable register 1, offset:
                         0x214 */
 ...
 */
/** TODO: make difference between LPC844 and LPC845 as they have different
 * peripherals */
typedef enum {
 ...
 * @param   peripheral  base address of SYSCON peripheral
 * @param   resets0     Settings for reset control 0 register, see RESETCTRL0
 * enum
 * @param   resets1     Settings for reset control 1 register, see RESETCTRL1
 * enum
 * @return  Nothing
 */
