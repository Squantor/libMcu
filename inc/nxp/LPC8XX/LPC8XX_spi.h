...
#define SPI_TXDATCTL_ASSERTNUM_SSEL(n) \
  (~(1 << ((n) + 16)) & 0x000F0000) /*!< Assert SSELN pin */
 ...
 */
static inline void SpiWriteTXDataAndCtrl(SPI_Type *pSPI, uint32_t control,
                                         uint16_t data) {
