...
namespace VTOR {
constexpr inline std::uint32_t kRESERVED_MASK{0xFFFFFF80u}; /*!< register mask for allowed bits */
...
namespace SHP {
constexpr inline std::uint32_t kRESERVED_MASK{0xC0C0C0C0u}; /*!< register mask for allowed bits */
}
namespace SHCSR {
constexpr inline std::uint32_t kRESERVED_MASK{0x00008000u};    /*!< register mask for allowed bits */
