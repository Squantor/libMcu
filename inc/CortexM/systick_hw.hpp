...
namespace CSR {
constexpr inline std::uint32_t kkRESERVED_MASK{0x00010007u}; /*!< register mask for allowed bits */
...
namespace CVR {
constexpr inline std::uint32_t kkRESERVED_MASK{0x00FFFFFFu}; /*!< register mask for allowed bits */
constexpr inline std::uint32_t kCURRENT_MASK{0x00FFFFFFu};   /*!< current value of systick timer */
}  // namespace CVR
namespace CALIB {
constexpr inline std::uint32_t kkRESERVED_MASK{0xC0FFFFFFu}; /*!< register mask for allowed bits */
